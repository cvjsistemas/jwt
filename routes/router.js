...
const {getlogin,getdashboard,getmanuals,getmantes,getforgotpass,getcreatenewpass,login,logout,forgotpass,updatenewpass} = require('../controllers/authController');
